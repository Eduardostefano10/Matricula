...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] options = {"5000", "8000", "10000"};
    ...
    public void logicamatematica() {
        ...
        // Aplicar el descuento del 12%
        double discount = 0.12; // 12%
        double discountedResult = finalResult * (1 - discount);
        totalText.setText(String.valueOf(discountedResult));


        String discountComment = "12% descuento aplicado: S/. " + (finalResult - discountedResult);
